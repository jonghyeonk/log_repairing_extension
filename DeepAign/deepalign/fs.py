...
class ModelFile(File):
    ...
    def __init__(self, path):
        ...
        self.event_log_name, self.model_name = split_model_name(self.name)
...
class AlignerFile(ModelFile):
    ...
    def __init__(self, path):
        ...
        self.event_log_name, self.ad = split_model_name(self.name)
        self.model, self.p, self.id = split_eventlog_name(self.event_log_name)
